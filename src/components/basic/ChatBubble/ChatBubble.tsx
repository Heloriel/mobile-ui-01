  ...
  if (incoming) {
    return (
      <div className="relative flex">
        ...
        <span className="flex p-3 bg-blue-300 rounded-t-lg rounded-r-lg my-2 break-all">{children}</span>
      </div>
    );
  } else {
    return (
      <div className="relative flex justify-end">
        ...
        <span className="flex p-3 bg-blue-100 rounded-t-lg rounded-l-lg my-2 break-all">{children}</span>
      </div>
    );
  }
}
